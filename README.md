...
**character_chat_bot**: This folder contains the code for building a character chatbot with LLMs to chat with your favorite characters from the series.
